...
export default function PathfinderPanel() {
  ...
  useEffect(() => {
    if (aiSuggestions.length === 0) getWhatNext();
  }, [getWhatNext, aiSuggestions.length]);
  ...
  return (
    <div className="p-6 rounded-2xl bg-orange-primary/5 border border-orange-primary/10 mb-8 overflow-hidden relative group">
      <div className="flex items-center justify-between mb-4 relative z-10">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={isLoading ? 'animate-spin' : ''}>
